with routing_group as (
    ...
    select * from {{ ref('int_edi_856_sb1__gfs_routing_group_case_level') }}

    union all

    select * from {{ ref('int_edi_856_sb1__gfs_routing_group_raw_material') }}
...
/* For Testing */
-- where order_id IN ('AFO024565','TNS125481')
