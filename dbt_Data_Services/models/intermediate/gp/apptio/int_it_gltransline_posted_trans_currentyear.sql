...
{% for schema in schema_list %}
    ...
    select
        ...
        gltptc.debitamt,
        gltptc.polldtrx,
        to_char(orpstddt, 'YYYY-MM-DD') as orpstddt,
        ...
        gltptc.orgntsrc,
        to_char(trxdate, 'YYYY-MM-DD') as trxdate,
        gltptc.voided,
        gltptc.ortrxsrc,
        gltptc.rctrxseq,
        to_char(lstdtedt, 'YYYY-MM-DD') as lstdtedt,
        gltptc.dta_index,
        gltptc.xchgrate,
        gltptc.mctrxstt,
        gltptc.periodid,
        ...
        gltptc.orgnatyp,
        to_char(docdate, 'YYYY-MM-DD') as docdate,
        gltptc.ppsgnmbr,
        gltptc.ortrxtyp,
    ...
    from gp.{{ schema }}.gl20000 as gltptc
