...
rm20101 as (
    select * from {{ ref('stg_gp_gdvii__rm20101') }}
),

rm30101 as (
    select * from {{ ref('stg_gp_gdvii__rm30101') }}
),

rm10101 as (
    select * from {{ ref('stg_gp_gdvii__rm10101') }}
),

rm30301 as (
    select * from {{ ref('stg_gp_gdvii__rm30301') }}
),

rm00101 as (
    select * from {{ ref('stg_gp_gdvii__rm00101') }}
),
