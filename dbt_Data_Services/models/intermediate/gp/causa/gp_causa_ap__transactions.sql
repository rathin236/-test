...
pm20000 as (
    select * from {{ ref('stg_gp_causa__pm20000') }}
),

pm30200 as (
    select * from {{ ref('stg_gp_causa__pm30200') }}
),

pm10100 as (
    select * from {{ ref('stg_gp_causa__pm10100') }}
),

pm30600 as (
    select * from {{ ref('stg_gp_causa__pm30600') }}
),

pm00200 as (
    select * from {{ ref('stg_gp_causa__pm00200') }}
),
...
select * from causa_ap_transactions
