...
rm20101 as (
    select * from {{ ref('stg_gp_ndhc__rm20101') }}
),

rm30101 as (
    select * from {{ ref('stg_gp_ndhc__rm30101') }}
),

rm10101 as (
    select * from {{ ref('stg_gp_ndhc__rm10101') }}
),

rm30301 as (
    select * from {{ ref('stg_gp_ndhc__rm30301') }}
),

rm00101 as (
    select * from {{ ref('stg_gp_ndhc__rm00101') }}
),
