with ap_invoices as (
    ...
    select * from {{ ref('stg_sage_100_bim__ap_invoicehistoryheader') }}

),

ap_payments as (

    select * from {{ ref('int_sage_100_bim__ap_payments') }}

),

ar_invoices as (

    select * from {{ ref('stg_sage_100_bim__ar_invoicehistoryheader') }}
...
gl_details as (
    ...
    select * from {{ ref('stg_sage_100_bim__gl_detailposting') }}
