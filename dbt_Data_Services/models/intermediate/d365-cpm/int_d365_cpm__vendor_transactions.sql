...
with gjae as (
    ...
    where ledgeraccount like '210000%' or ledgeraccount like '210030%' or ledgeraccount like '210020%' or ledgeraccount like '210010%'
),
...
final as (
    select
        ...
        vt.accountnum as customer_vendor_id,
