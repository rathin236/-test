...
with gjae as (
    ...
    where ledgeraccount like '120010%' or ledgeraccount like '120000%' or ledgeraccount like '120030%' or ledgeraccount like '120020%'
),
...
final as (
    select
        ...
        ct.accountnum as customer_vendor_id,
        --accounting currency debits and credits
        dpt.name as customer_vendor_name,
        ct.invoice as document_number,
        --subledger details
        gje.documentdate as document_date, --Ojo aqui
        gjae.transactioncurrencycode as transaction_currency,
        '' as canceled, --Ojo Aqui
