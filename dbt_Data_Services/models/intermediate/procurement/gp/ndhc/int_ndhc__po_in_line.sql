...
currency_mapping as (
    ...
    from {{ ref('stg_gp_ndhc__mc020103') }}
...
po_active as (
    select * 
    from {{ ref("stg_gp_ndhc__pop10110") }} where dex_row_ts > '2022-12-31'
),

po_historic as (
    select *
    from {{ ref("stg_gp_ndhc__pop30110") }} where prmdate > '2022-12-31'
),
