...
po_active as (
    select {{ trim_columns_int('stg_gp_cai__pop10110') }} 
    from {{ ref("stg_gp_cai__pop10110") }} where dex_row_ts > '2022-12-31'
),

po_historic as (
    select {{ trim_columns_int('stg_gp_cai__pop30110') }}
    from {{ ref("stg_gp_cai__pop30110") }} where prmdate > '2022-12-31'
),
