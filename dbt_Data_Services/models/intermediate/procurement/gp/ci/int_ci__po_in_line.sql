...
po_active as (
    select * 
    from {{ ref("stg_gp_ci__pop10110") }} where dex_row_ts > '2022-12-31'
),

po_historic as (
    select *
    from {{ ref("stg_gp_ci__pop30110") }} where prmdate > '2022-12-31'
),
