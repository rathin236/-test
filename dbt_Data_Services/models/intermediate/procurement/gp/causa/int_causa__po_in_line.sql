...
currency_mapping as (
    ...
    from {{ ref('stg_gp_causa__mc020103') }}
    ...
    from {{ ref('stg_gp_causa__mc40000') }}
),
...
po_active as (
    select * 
    from {{ ref("stg_gp_causa__pop10110") }} where dex_row_ts > '2022-12-31'
),

po_historic as (
    select *
    from {{ ref("stg_gp_causa__pop30110") }} where prmdate > '2022-12-31'
),
