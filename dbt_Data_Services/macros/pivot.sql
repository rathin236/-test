{#
######################
Martin Palkovic Notes:
I copied this from https://github.com/dbt-labs/dbt-utils/blob/main/macros/sql/pivot.sql to see if I could
do better with the whitespace handling. It is a lot better!

You call this just like before using {{ dbt_utils.pivot(<column>, <list of values>) }}
######################
